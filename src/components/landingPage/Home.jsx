    ...
    return (
        ...
        >
            <div className="w-full md:w-[90%] flex flex-col sm:flex-row items-center justify-center gap-8 md:gap-6">
                ...
                <motion.div
                    className="relative min-w-[95%] max-w-[98%] sm:min-w-[400px] sm:mix-w-none md:min-w-[450px] lg:min-w-[480px] aspect-[480/490] overflow-hidden flex flex-row justify-center items-center"
