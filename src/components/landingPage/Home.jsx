import { Mail, MoveDown, MoveRight } from "lucide-react";
...
export default function Home() {
    ...
    return (
        <div
            ref={cardRef}
            className="pt-20 px-5 md:px-10 w-full h-[100svh] flex items-center justify-center overflow-x-hidden"
        >
            <div className="w-full md:w-[90%] flex flex-col sm:flex-row items-center justify-center gap-8 md:gap-6">
                ...
                <motion.div
                    className="relative min-w-[400px] max-w-[450px] sm:min-w-[400px] sm:mix-w-none md:min-w-[450px] lg:min-w-[480px] aspect-[480/490] overflow-hidden flex flex-row justify-center items-center"
                ...
                >
                    <div className="relative w-full max-w-[480px] aspect-[480/490] overflow-hidden">
                        ...
                        <div className="absolute top-[3%] left-[5%] flex flex-col items-end">
                            ...
                            <div className="text-xs font-bold antonio">
                                {" "}
                                - Arijit
                            </div>
                        </div>
